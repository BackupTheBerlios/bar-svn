...
typedef enum
{
  CRYPT_ALGORITHM_NONE       = 0,

  CRYPT_ALGORITHM_3DES       = 1,
  CRYPT_ALGORITHM_CAST5      = 2,
  CRYPT_ALGORITHM_BLOWFISH   = 3,
  CRYPT_ALGORITHM_AES128     = 4,
  CRYPT_ALGORITHM_AES192     = 5,
  CRYPT_ALGORITHM_AES256     = 6,
  CRYPT_ALGORITHM_TWOFISH128 = 7,
  CRYPT_ALGORITHM_TWOFISH256 = 8,
